...
const staff = {
  email: 'PENHALLOW@kingsmere.example',
  fullName: 'Ruth Penhallow',
  password: 'kingsmere-Third-tee-88',
...
describe('signing in', () => {
  it('hands back a session', async () => {
    ...
    expect(res.body.user.fullName).toBe('Ruth Penhallow');
  });
